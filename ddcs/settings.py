...
SECRET_KEY = 'django-insecure-_b2obuhy@4*v9k1q^l94!(n^i-xfic+fn(7*6l^2%zq#x%(55n'
...
MIDDLEWARE = [
    ...
    'ddcs.sys.middleware.session_check',
]
ROOT_URLCONF = 'ddcs.urls'
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'ddcs.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(LOG_DIR, 'ddcs.log'),       # 这是将普通日志写入到日志文件中的方法，
            'formatter': 'standard'
        },
        'default': {
            'level': 'DEBUG',
